...
- Available Nuke license.
   - You CAN use a Nuke render license, BUT you must omit the "-i" in the command building function. Otherwise it will use your interactive available license (the one you use to work).
